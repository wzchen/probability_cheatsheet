...
The distribution of a random variable $X$ over the interval $a < X \le b$ is given by: \medskip
%\textbf{Truncated PDF}
\[f_X(x | a < X \le b) = \frac{g(x)} {F_X(b) - F_X(a)}\]
where $g(x) = f_X(x)$ for all $a < x \le b$ and $g(x) = 0$ otherwise.
