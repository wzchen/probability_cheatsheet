...
William and Sebastian play a modified game of Settlers of Catan, where every turn they randomly move the robber (which will start on the center tile) on a game board to one of the adjacent hexagons. (refer to a picture of the game board if confused)

% unfortunately this was too large to include in the cheatsheet but feel free to uncomment this
% \begin{center}
...
% \node [circle,minimum size=1cm] at (h2;2) {Desert};
% \foreach \j in {0,...,1}{%
